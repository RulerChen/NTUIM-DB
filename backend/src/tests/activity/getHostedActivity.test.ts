import { getHostedActivity } from '@/controllers/activity.controller';
...
describe('getHostedActivity', () => {
  afterEach(() => {
    jest.clearAllMocks();
  });

  it('should return active hosted activities for a member', async () => {
    ...
    await getHostedActivity(req as Request, res as Response);
