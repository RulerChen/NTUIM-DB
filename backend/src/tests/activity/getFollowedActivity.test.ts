import { getFollowedActivity } from '@/controllers/activity.controller';
...
describe('getFollowedActivity', () => {
  afterEach(() => {
    jest.clearAllMocks();
  });

  it('should return active followed activities for a member', async () => {
    ...
    await getFollowedActivity(req as Request, res as Response);
